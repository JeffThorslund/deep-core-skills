...
- **[teach](./plugins/deep-core-skills/skills/teach/SKILL.md)** — Stateful, multi-session tutor: treats the current directory as a teaching workspace (`MISSION.md`, `RESOURCES.md`, learning records, HTML lessons and reference docs) and teaches one tightly-scoped thing per lesson, grounded in the user's mission and zone of proximal development.
